...
<div class="table">
	...
	<table class="lead-view">
		...
		@endif
		@if(isset($lead['third_vehicle_year']) && $lead['third_vehicle_year'])
		<tr>
			<td>3.</td>
		...
		@endif
		@if(isset($lead['fourth_vehicle_year']) && $lead['fourth_vehicle_year'])
		<tr>
			<td>4.</td>
		...
		@endif		
		@if(isset($lead['fifth_vehicle_year']) && $lead['fifth_vehicle_year'])
		<tr>
			<td>5.</td>
		...
		@endif
		@if(isset($lead['sixth_vehicle_year']) && $lead['sixth_vehicle_year'])
		<tr>
			<td>6.</td>
		...
		@endif
		@if(isset($lead['seventh_vehicle_year']) && $lead['seventh_vehicle_year'])
		<tr>
			<td>7.</td>
		...
		@endif
		@if(isset($lead['eighth_vehicle_year']) && $lead['eighth_vehicle_year'])
		<tr>
			<td>8.</td>
		...
		@endif
		@if(isset($lead['ninth_vehicle_year']) && $lead['ninth_vehicle_year'])
		<tr>
			<td>9.</td>
		...
		@endif
		@if(isset($lead['tenth_vehicle_year']) && $lead['tenth_vehicle_year'])
		<tr>
			<td>10.</td>
	...
	<table class="lead-view">
		...
		<th>
			<strong>DATE:</strong>
			<span>{{ Carbon\Carbon::parse($lead['created_at'])->format('Y M d') }}</span>
		</th>
		<th>
			<strong>TIME:</strong>
			<span>{{ Carbon\Carbon::parse($lead['created_at'])->format('h:i:s A') }}</span>
		</th>
	</table>
</div>