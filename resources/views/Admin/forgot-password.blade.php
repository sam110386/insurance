...
<head>
  ...
  <title>{{config('admin.title')}} | {{ trans('admin.forgot_password') }}</title>
  ...
  <div class="login-box-body">
    ...
    <form action="{{ route('forgot-password-post') }}" method="post">
      <div class="form-group has-feedback {!! !$errors->has('email') ?: 'has-error' !!} ">
        ...
        <input type="email" class="form-control" placeholder="{{ trans('admin.email') }}" name="email" value="{{ old('email') }}" required="">
