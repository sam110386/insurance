$(document).ready(function(){
	$('#reviewPopup').on('click','.edit-field',function(){
	...
	$('.cancel-review').on('click',function(){
		$('form > .container').fadeOut();
		$('form > .container#last-container').fadeIn();
		$("#reviewPopup").modal('hide');
	})
	$('.review-application').on('click',function(){
		...
		$("#reviewPopup").modal({backdrop: 'static', keyboard: false});

	});

	$(document).on('fadeOut','.review-on',function(){
		$(this).removeClass('review-on');
		$('.review-application').delay(500).trigger('click');
	});
	...
	function getVehicleHtml(){
		...
		vehicle1 += "<td><a href='javascript:;' class='edit-field' data-target='#year-container'><i class='fa fa-edit'></i></a></td>";
		vehicle1 += "</tr>";
		// Second vehicle
		var vehicle2 = "";
		if($("input[name=miles-driven-per-year-vehicle-2]:checked").val()){
			...
			vehicle2 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle2-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle2 += "</tr>";
		}
		// Third vehicle
		var vehicle3 = "";
		if($("input[name=miles-driven-per-year-vehicle-3]:checked").val()){
			...
			vehicle3 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle3-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle3 += "</tr>";
		}
		// Fourth vehicle
		var vehicle4 = "";
		if($("input[name=miles-driven-per-year-vehicle-4]:checked").val()){
			...
			vehicle4 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle4-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle4 += "</tr>";
		}
		// Fifth vehicle
		var vehicle5 = "";
		if($("input[name=miles-driven-per-year-vehicle-5]:checked").val()){
			...
			vehicle5 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle5-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle5 += "</tr>";
		}
		// Sixth vehicle
		var vehicle6 = "";
		if($("input[name=miles-driven-per-year-vehicle-6]:checked").val()){
			...
			vehicle6 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle6-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle6 += "</tr>";
		}
		// Seventh vehicle
		var vehicle7 = "";
		if($("input[name=miles-driven-per-year-vehicle-7]:checked").val()){
			...
			vehicle7 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle7-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle7 += "</tr>";
		}
		// Eighth vehicle
		var vehicle8 = "";
		if($("input[name=miles-driven-per-year-vehicle-8]:checked").val()){
			...
			vehicle8 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle8-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle8 += "</tr>";
		}
		// Ninth vehicle
		var vehicle9 = "";
		if($("input[name=miles-driven-per-year-vehicle-9]:checked").val()){
			...
			vehicle9 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle9-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle9 += "</tr>";
		}
		// Tenth vehicle
		var vehicle10 = "";
		if($("input[name=miles-driven-per-year-vehicle-10]:checked").val()){
			...
			vehicle10 += "<td><a href='javascript:;' class='edit-field' data-target='#vehicle10-year-container'><i class='fa fa-edit'></i></a></td>";
			vehicle10 += "</tr>";
		}
	...
	function insuranceHtml(){
		...
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#previous-insurance-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";
		...
		if(previousIns == 1){
			...
			html += "<a class='pull-right edit-field' href='javascript:;' data-target='#current-insurance-container' ><i class='fa fa-edit'></i></a>";
			html += "</p>";
			...
			html += "<a class='pull-right edit-field' href='javascript:;' data-target='#current-insurance-duration-container' ><i class='fa fa-edit'></i></a>";
			html += "</p>";
		}
		return html;
	}
	...
	function getPersonalInfoHtml(){
		...
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#married-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";
		...
		if(married == 1){
			...
			html += "<a class='pull-right edit-field' href='javascript:;' data-target='#children-container' ><i class='fa fa-edit'></i></a>";
			html += "</p>";
		}
		html += "<h5>Do you own/rent?</h5>";
		html += "<p>";
		html += $('input[name=homeowner]:checked').val();
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#homeowner-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";
		...
		html += "<h5><strong>Has anyone on this policy had:</strong></h4>";
		html += "<h5>An at-fault accident in the past <strong>three (3) years?</strong></h5>";
		html += "<p>";
		html += ($('input[name=at_fault]:checked').val() == 1 ) ? "Yes" : "No";
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#policy-detail-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";

		html += "<h5><strong>Two (2) or more tickets</strong> in the past <strong>three (3) years?</strong></h5>";
		html += "<p>";
		...
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#extra-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";	
		...
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#referral-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";	
	...
	function getDriverHtml(){
		...
		driver1 += "<td><a href='javascript:;' class='edit-field' data-target='#name-email1-container' ><i class='fa fa-edit'></i></a></td>";
		driver1 += "</tr>";
		...
		if($('input[name=first_name2]').val() && $('input[name=dl2]').val()){			
			...
			driver2 += "<td><a href='javascript:;' class='edit-field' data-target='#name2-container' ><i class='fa fa-edit'></i></a></td>";
			driver2 += "</tr>";		
		}
		var driver3 = "";
		if($('input[name=first_name3]').val() && $('input[name=dl3]').val()){			
			...
			driver3 += "<td><a href='javascript:;' class='edit-field' data-target='#name3-container' ><i class='fa fa-edit'></i></a></td>";
			driver3 += "</tr>";		
		}
		var driver4 = "";
		if($('input[name=first_name4]').val() && $('input[name=dl4]').val()){			
			...
			driver4 += "<td><a href='javascript:;' class='edit-field' data-target='#name4-container' ><i class='fa fa-edit'></i></a></td>";
			driver4 += "</tr>";		
		}
		var driver5 = "";
		if($('input[name=first_name5]').val() && $('input[name=dl5]').val()){			
			...
			driver5 += "<td><a href='javascript:;' class='edit-field' data-target='#name5-container' ><i class='fa fa-edit'></i></a></td>";
			driver5 += "</tr>";		
		}
	...
	function getContactInfoHtml(){
		...
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#last-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";

		html += "<h5>Email</h5>";
		html += "<p>";
		html += $('input[name=email]').val();
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#name-email1-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";
		...
		html += "<a class='pull-right edit-field' href='javascript:;' data-target='#zipcode-container' ><i class='fa fa-edit'></i></a>";
		html += "</p>";			
		return html;							
	}
})